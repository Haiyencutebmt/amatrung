            ...
            <div class="form-grid">
                ...
                <div class="form-group full-width">
                    ...
                    <textarea id="usage_instruction" name="usage_instruction"
                        ...
                        placeholder="Ví dụ: Sắc 3 bát nước còn 1 bát...">{{ old('usage_instruction') }}</textarea>
                </div>
                ...
                <div class="form-group full-width">
                    ...
                    <textarea id="general_note" name="general_note"
                        ...
                        placeholder="Ví dụ: Kiêng đồ tanh, cay nóng...">{{ old('general_note') }}</textarea>
                </div>
            </div>

            <div class="items-wrapper">
                <h3>Chi tiết các vị thuốc <span class="required">*</span></h3>
                <p style="color: var(--text-muted); font-size: 14px; margin-bottom: 15px;">Thêm các dược liệu vào đơn thuốc. Tổng số vị: <span id="total-items">0</span></p>
