...
@section('content')
    <div class="records-toolbar">
        <form action="{{ route('admin.prescriptions.index') }}" method="GET" class="search-box">
            <input type="text" name="search" placeholder="Tìm tên bệnh nhân, mã hồ sơ hoặc mã đơn"
                ...
                <tbody>
                    @forelse($prescriptions as $prescription)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('admin.medical-records.show', $prescription->medicalRecord) }}"
                                    class="record-code-badge"
                                    style="text-decoration: underline; background: var(--bg-page); color: var(--text-muted);">
                            ...
                            <td>
                                <div class="action-btns">
                                    ...
                                    <form method="POST" action="{{ route('admin.prescriptions.destroy', $prescription) }}"
                                        class="form-delete" data-name="{{ $prescription->prescription_code }}"
                    ...
                    @empty
                        <tr>
                            <td colspan="6" class="empty-state">
                                ...
                                <a href="{{ route('admin.prescriptions.create') }}" class="btn-add">➕ Thêm đơn thuốc đầu
                                    tiên</a>
                            </td>
                        </tr>
                    @endforelse
